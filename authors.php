...
<div style="margin-bottom: 1%;">
		...
		<p><div class="callout">Call for Tutorial Sessions:</div> Tutorial sessions and panel discussions addressing state-of-the-art control theory and advanced industrial applications are solicited.</p>

		<p><div class="callout">Call for Workshops and Tutorials:</div> Workshops and tutorials to be held prior to the conference are solicited on all related topics. Proposals for workshops addressing novel control methodologies and nonstandard control applications are strongly encouraged.</p>

		<div class="spacer"></div>
		<h1>Submission Specifics</h1>

		All papers and session proposals must be submitted through the conference submission website <a style="color:red" href="css.paperplaza.net">http://css.paperplaza.net</a> and must be submitted in English. All submissions must conform to the following policy: 
		<ul>
