...
<div style="margin-bottom: 1%;">
		...
		<ul>
			<li>All submitted papers must be formatted in the standard 2-column Proceedings format. <a target="_blank" style="color:red" href="http://css.paperplaza.net/conferences/support/support.php">Click here</a> for author kits with style (.cls) files for LaTeX and templates (.dot) for MS-Word.</li>
